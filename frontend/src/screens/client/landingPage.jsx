...
function LandingPageAdmin() {
    ...
    return (
        <div id='landingPage' data-theme={"myTheme"} className='fontZain overflow-hidden'>
            <div className='h-fit'>
                <div className='h-full relative'>
                    <div data-aos="zoom-out" className="w-full m-0 py-[0.5rem] sm:pt-[2rem] h-full lg:h-[85vh] bg-neutral rounded-b-[4rem] sm:rounded-b-[7rem]">
                        ...
                        <div className='flex flex-col-reverse lg:flex-row-reverse justify-between items-center container mx-auto'>
                            ...
                            <div className='w-full lg:w-1/2'>
                                <h1 className={`relative text-center ${i18n.language === 'ar' ? 'sm:text-right' : 'sm:text-left'} z-50 relative md:text-[72px] sm:text-[2rem] leading-[2rem] md:leading-[4.5rem] pt-[3rem] font-[900]`}>
                                ...
                                <div className={`mt-[0.5rem] sm:mt-[2rem] flex justify-center sm:justify-start`}>
                                    <Link to="/signUp" className='btn btn-primary font-bold md:text-xl h-auto md:w-[10rem] md:py-[1rem]'>
                                        {t('sign_up_button')}
                                    </Link>
                                </div>
                    ...
                    <div className='relative lg:top-[-3rem] w-screen'>
